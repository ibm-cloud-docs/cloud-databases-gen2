...
Instances that are configured with the optional bring your own key (BYOK) capability have their data shredded. The data is inaccessible when the customer-owned encryption key is deleted from the Key Protect or Hyperprotect Crypto Services instance. For more information, see [Deleting your deployment and removing your data](/docs/cloud-databases-gen2?topic=cloud-databases-gen2-deprovisioning&interface=ui).
