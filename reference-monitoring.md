...
| `Value Type`  | `count` |
| `Segment By` | `Service instance, Service instance name` |
{: caption="The total number of EnterpriseDB connections being used metric metadata" caption-side="top"}
...
## Independent backups metrics
{: #metrics-by-plan-independent-backups}

| Metric Name |
|-----------|
| [Independent backups total backups successful](#ibm_databases_independent_backups_total_backups_successful) |
{: caption="Metrics available by plan names" caption-side="top"}

### Independent backups metrics
{: #metrics-by-plan-independent-backups-desc}

#### Independent backups total backups successful
{: #ibm_databases_independent_backups_total_backups_successful}

Total number of successful backups for independent backup service

| Metadata | Description |
|----------|-------------|
| `Metric Name` | `ibm_databases_independent_backups_total_backups_successful`|
| `Metric Type` | `gauge` |
| `Value Type`  | `number` |
| `Segment By` | `Source data service CRN, Source data service type, Source data service version, Backup type` |
{: caption="Total backups successful metric metadata" caption-side="top"}
...
| `Service Name` | `ibm_service_name` | Name of the service generating this metric. Not applicable for {{site.data.keyword.databases-for}}'s independent backups. |
...
| Attribute | Attribute Name | Attribute Description |
|-----------|----------------|-----------------------|
| `Service instance` | `ibm_service_instance` | The service instance segment identifies the instance the metric is associated with. Not applicable for {{site.data.keyword.databases-for}}'s independent backups. |
